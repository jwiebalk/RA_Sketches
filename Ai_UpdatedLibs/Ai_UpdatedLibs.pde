...
#define T3HIGH  1000
 ...
 prog_char menu4_label[] PROGMEM = "Thunder Storm";
 
 PROGMEM const char *menu_items[] = {
   menu1_label, menu2_label, menu3_label, menu4_label};
...
void loop()
{
  ...
  {
    WhiteValue=PWMSlope(9,0,21,0,3,33,200,3);
    BlueValue=PWMSlope(9,0,21,0,8,38,240,8);
    RoyalBlueValue=PWMSlope(9,0,21,0,8,38,240,8);
    CheckCloud();
